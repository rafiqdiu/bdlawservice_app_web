...
export default class RunningCourtButton extends Component{    //Start code for expo push notification
  ...
  render() {
    return (<> 
      ...
      <View style={{flex:1, 
    alignItems: 'center',
    paddingTop: 5, marginTop:55}}>
      {/* <Text style={styles.titleTextOnes}>Search List By Date</Text> */}
       ...
       {this.state.loader == false &&
         <>
          {/* <TouchableOpacity
             ...
             // onPress={() => this.props.navigation.navigate('AppellateDivision')}
              onPress={() => { this.state.Adaccess==="0"?this.props.navigation.navigate('AppellateDivisionMsg'):this.props.navigation.navigate('AppellateDivision')}}
            >
            ...
            <TouchableOpacity
                style={styles.buttonR}
                onPress={() =>this.props.navigation.navigate('HighCourtDivision')}
              >
              <Text style={styles.buttonTextMessage}>High Court Division</Text>
            </TouchableOpacity> */}

          
        <TouchableOpacity    onPress={() => { this.state.Adaccess==="0"?this.props.navigation.navigate('AppellateDivisionMsg'):this.props.navigation.navigate('AppellateDivision')}}  
        ...
        <TouchableOpacity   onPress={() =>this.props.navigation.navigate('HighCourtDivision')}   
         style={styles.buttonAll}          
          ><LinearGradient 
